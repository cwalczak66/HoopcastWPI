# -*- coding: utf-8 -*-
"""
Created on Wed Sep 25 12:13:35 2024
...
# group games by home and away
home_win_percent = data.groupby("home").apply(lambda x: x[x["won"] == 1].shape[0] / x.shape[0])

# create rolling averages to improve model
